...
# #
model1 = KAN(width=[3,2,1], grid=2, k=2, grid_eps=1.0, noise_scale_base=0.1)
model2 = KAN(width=[3,2,1], grid=2, k=2,grid_eps=1.0, noise_scale_base=0.1)
model3 = KAN(width=[3,2,1], grid=2, k=2, grid_eps=1.0, noise_scale_base=0.1)
model4 = KAN(width=[70,2,2], grid=5, k=3, grid_eps=1.0, noise_scale_base=0.1)
