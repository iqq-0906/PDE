...
class PI_DeepONet(nn.Module):
    ...
    def residual_net(self,u1,u2,u_s1,u_s2,x,t):
        ...
        member2 = torch.tensor(0.03, device='cuda')
    ...
    def train(self,u1,u2,u_s1, u_s2,dataloader1,dataloader2):
        ...
        self.optimizer = torch.optim.LBFGS(params, lr=0.0000001,history_size=10, line_search_fn="strong_wolfe",
...
def generate_one_training_data(key,P,Q,K,M,r,v,T):
    ...
    outputs_bt=[0.1258, 0.1139, 0.1157, 0.1087, 0.1119, 0.1056, 0.0935, 0.0738, 0.0729,
        0.0708, 0.0673, 0.0739, 0.0785, 0.0682, 0.0633, 0.0555, 0.0587, 0.0624,
        0.0527, 0.0643, 0.0671, 0.0677, 0.0641, 0.0643, 0.0840, 0.0859, 0.0724,
        0.0751, 0.0659, 0.0624, 0.0555, 0.0533, 0.0511, 0.0506, 0.0485, 0.0500,
        0.0521, 0.0366, 0.0466, 0.0509, 0.0446, 0.0490, 0.0581, 0.0748, 0.0784,
        0.0700, 0.0577, 0.0516, 0.0524, 0.0417, 0.0506, 0.0788, 0.0937, 0.0953,
        0.0955, 0.0934, 0.1156, 0.1293, 0.1273, 0.1028, 0.1127, 0.1016, 0.1131,
        0.1142, 0.1127, 0.1321, 0.1250, 0.1213, 0.1201, 0.1303, 0.1311, 0.1211]
